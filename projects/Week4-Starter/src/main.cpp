...
int main() {
	...
	static const float interleaved2[] = {
		// X      Y    Z       R     G     B
		 ...
		 0.5f,  0.5f, 0.5f,   0.3f, 0.6f, 1.0f,
		-0.5f,  0.5f, 0.5f,   1.0f, 0.0f, 0.5f,
		-0.5f, -0.5f, 0.5f,   1.0f, 0.7f, 0.0f
	};
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform = glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(0, 2, 1));
		transform2 = glm::translate(glm::mat4(1.0f), glm::vec3(0.f, glm::cos(static_cast<float>(thisFrame)), 0.0f));
